 ...
 * @key: The key, string
 * The key is unique in the HashTable
 * @value: This is a value corresponding to a key
 * @next: This is a pointer to the next node of the List
 * @sprev: This is a pointer to the previous element of the sorted linked list
 ...
 * @stail: This is a pointer to the last element of the sorted linked list
 */
